<template>
  <div class="relative w-full text-left" ref="containerRef">
    ...
    <div
      v-if="isOpen"
      :class="[
        'absolute z-50 w-full bg-slate-900/95 backdrop-blur-md border border-slate-700/80 rounded-md shadow-2xl overflow-hidden py-1 max-h-56 overflow-y-auto custom-scrollbar overscroll-contain transition-all duration-150 animate-fadeIn',
